...
public class AccountInternalRestController {
	...
	public @ResponseBody List<AccountInternalResponse> findAll() {
	...
	public @ResponseBody List<Long> save(@RequestBody final List<AccountInternalSaveRequest> saveRequests) throws FunctionalException {
	...
	public @ResponseBody List<Long> update(@RequestBody final List<AccountInternalUpdateRequest> updateRequests) throws FunctionalException {
