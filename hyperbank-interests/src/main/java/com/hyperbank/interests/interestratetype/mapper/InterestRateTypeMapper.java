...
public abstract class InterestRateTypeMapper implements BaseFullMapper<InterestRateType, InterestRateTypeSaveRequest, InterestRateTypeUpdateRequest, InterestRateTypeResponse> {
