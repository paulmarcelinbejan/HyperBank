...
public abstract class InterestRateFixedMapper implements BaseFromSaveToResponseMapper<InterestRateFixed, InterestRateFixedSaveRequest, InterestRateFixedResponse> {
